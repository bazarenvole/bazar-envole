...
const line = document.querySelector(".timeline-timeline-innerline");

let i = 0;
let i2 = 1;
let target1 = document.querySelector(".timeline-ul");
let target2 = document.querySelectorAll(".timeline-ul .timeline-li");

const timeline_events = document.querySelectorAll(".timeline-ul .timeline-li");

function showTime(e) {
    e.setAttribute("done", "true");
    e.querySelector(".timeline-timeline-point").style.background = "blue";
    e.querySelector(".timeline-date").style.opacity = "100%";
...
function hideTime(e) {
    ...
    e.querySelector(".timeline-timeline-point").style.background = "rgb(228, 228, 228)";
